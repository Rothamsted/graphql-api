...
exports.extractSchemaDefinitions = exports.printSchemaDocument = exports.setDefaultConfig = exports.shouldAugmentRelationshipField = exports.shouldAugmentType = exports.mergeDefinitionMaps = exports.mapDefinitions = exports.augmentedSchema = exports.makeAugmentedExecutableSchema = void 0;
...
var makeAugmentedExecutableSchema = function makeAugmentedExecutableSchema(_ref) {
  var typeDefs = _ref.typeDefs,
      ...
      _ref$schemaTransforms = _ref.schemaTransforms,
      schemaTransforms = _ref$schemaTransforms === void 0 ? [] : _ref$schemaTransforms,
  ...
  if (isParsedTypeDefs) {
    ...
    definitions = _lodash["default"].cloneDeep(typeDefs.definitions);
  } else {
  ...
  var augmentedResolvers = (0, _resolvers.augmentResolvers)({
    generatedTypeMap: generatedTypeMap,
    operationTypeMap: operationTypeMap,
    typeExtensionDefinitionMap: typeExtensionDefinitionMap,
    resolvers: resolvers,
  ...
  resolverValidationOptions.requireResolversForResolveType = false; // FIXME get this working
...
var mergeDefinitionMaps = function mergeDefinitionMaps(_ref3) {
  ...
  if (typeExtensions) {
    typeExtensions = typeExtensions.reduce(function (typeExtensions, extensions) {
      typeExtensions.push.apply(typeExtensions, (0, _toConsumableArray2["default"])(extensions));
      return typeExtensions;
    }, []);
  }

  var definitions = (0, _values["default"])(_objectSpread(_objectSpread({}, generatedTypeMap), directiveDefinitionMap));

  (_definitions = definitions).push.apply(_definitions, (0, _toConsumableArray2["default"])(typeExtensions));
...
var printSchemaDocument = function printSchemaDocument(_ref5) {
  ...
  return (0, _graphqlTools.printSchemaWithDirectives)(schema, {// FIXME add to testing once using this is supported
    // commentDescriptions: true
  });
};
/**
...
var extractSchemaDefinitions = function extractSchemaDefinitions(_ref6) {
  ...
  var definitions = (0, _values["default"])(_objectSpread(_objectSpread({}, schema.getDirectives()), typeMap)).reduce(function (astNodes, definition) {
