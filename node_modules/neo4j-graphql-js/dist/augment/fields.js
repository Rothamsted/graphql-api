...
exports.getTypeFields = exports.propertyFieldExists = exports.buildNeo4jSystemIDField = exports.toSnakeCase = exports.getFieldType = exports.getTypeExtensionFieldDefinition = exports.getFieldDefinition = exports.unwrapNamedType = exports.isListTypeField = exports.TypeWrappers = exports.isCustomScalarField = exports.isNeo4jIDField = exports.isSpatialField = exports.isTemporalField = exports.isNeo4jTypeField = exports.isBooleanField = exports.isStringField = exports.isFloatField = exports.isIntegerField = exports.isScalarField = exports.isPropertyTypeField = exports.Neo4jSystemIDField = void 0;
...
var isScalarField = function isScalarField(_ref2) {
  var kind = _ref2.kind,
      type = _ref2.type;
...
var isIntegerField = function isIntegerField(_ref3) {
  var type = _ref3.type;
...
var isFloatField = function isFloatField(_ref4) {
  var type = _ref4.type;
...
var isStringField = function isStringField(_ref5) {
  var kind = _ref5.kind,
      type = _ref5.type;
...
var isBooleanField = function isBooleanField(_ref6) {
  var type = _ref6.type;
...
var isNeo4jTypeField = function isNeo4jTypeField(_ref7) {
  var type = _ref7.type;
...
var isTemporalField = function isTemporalField(_ref8) {
  var type = _ref8.type;
...
var isSpatialField = function isSpatialField(_ref9) {
  var type = _ref9.type;
...
var isNeo4jIDField = function isNeo4jIDField(_ref10) {
...
var isCustomScalarField = function isCustomScalarField(_ref11) {
...
var isListTypeField = function isListTypeField(_ref12) {
  var _ref12$field = _ref12.field,
      field = _ref12$field === void 0 ? {} : _ref12$field;
  var type = field.type;
  var unwrappedType = unwrapNamedType({
    type: type
  });
  var typeWrappers = unwrappedType.wrappers;
...
var unwrapNamedType = function unwrapNamedType(_ref13) {
  var _unwrappedType$wrappe;

  var _ref13$type = _ref13.type,
      type = _ref13$type === void 0 ? {} : _ref13$type,
      _ref13$unwrappedType = _ref13.unwrappedType,
      unwrappedType = _ref13$unwrappedType === void 0 ? {} : _ref13$unwrappedType;
...
var getFieldDefinition = function getFieldDefinition(_ref14) {
...
var getTypeExtensionFieldDefinition = function getTypeExtensionFieldDefinition(_ref15) {
  var _ref15$typeExtensions = _ref15.typeExtensions,
      typeExtensions = _ref15$typeExtensions === void 0 ? [] : _ref15$typeExtensions,
      _ref15$name = _ref15.name,
      name = _ref15$name === void 0 ? '' : _ref15$name;
  return typeExtensions.find(function (extension) {
...
exports.getTypeExtensionFieldDefinition = getTypeExtensionFieldDefinition;
...
var buildNeo4jSystemIDField = function buildNeo4jSystemIDField(_ref17) {
  var typeName = _ref17.typeName,
      ...
      _ref17$isRelationship = _ref17.isRelationship,
      isRelationship = _ref17$isRelationship === void 0 ? false : _ref17$isRelationship;
  ...
  if ((0, _augment.shouldAugmentType)(config, queryTypeNameLower, typeName)) {
    ...
    var systemIDField = (0, _ast.buildField)({
      ...
      description: (0, _ast.buildDescription)({
        value: "Generated field for querying the Neo4j [system id](https://neo4j.com/docs/cypher-manual/current/functions/scalar/#functions-id) of this ".concat(entityDescription, "."),
        config: config
      })
    });
...
var propertyFieldExists = function propertyFieldExists(_ref18) {
  ...
  return fields.find(function (field) {
    ...
    var isListType = typeWrappers[TypeWrappers.LIST_TYPE];
    return !isListType && isPropertyTypeField({
      kind: outputKind,
      type: outputType
    });
  });
...
var getTypeFields = function getTypeFields(_ref19) {
  var _ref19$typeName = _ref19.typeName,
      typeName = _ref19$typeName === void 0 ? '' : _ref19$typeName,
      _ref19$definition = _ref19.definition,
      definition = _ref19$definition === void 0 ? {} : _ref19$definition,
  ...
  if (fields && fields.length) {
    ...
    allFields.push.apply(allFields, (0, _toConsumableArray2["default"])(fields));
    var extensions = typeExtensionDefinitionMap[typeName] || []; // also return any .fields of extensions of this type

    extensions.forEach(function (extension) {
      return allFields.push.apply(allFields, (0, _toConsumableArray2["default"])(extension.fields));
    });
  }
